...
switch (_weapongrade) do {
	...
	case 1: {
		...
		_unit setSkill ["aimingShake",(0.20 + random 0.20)];
		_unit setSkill ["aimingSpeed",(0.50 + random 0.40)];
		_unit setSkill ["endurance",(0.60 + random 0.40)];
		_unit setSkill ["spotDistance",(0.40 + random 0.20)];
	...
	case 3: {
		...
		_unit setSkill ["aimingShake",(0.35 + random 0.20)];
