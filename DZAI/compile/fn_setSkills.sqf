...
switch (_weapongrade) do {
	...
	case 1: {
		...
		_unit setSkill ["aimingSpeed",(0.70 + random 0.30)];
		_unit setSkill ["endurance",(0.60 + random 0.40)];
	...
	case 2: {
		...
		_unit setSkill ["aimingShake",(0.30 + random 0.20)];
		_unit setSkill ["aimingSpeed",(0.70 + random 0.30)];
	...
	case 3: {
		_unit setSkill ["aimingAccuracy",(0.25 + random 0.20)];
		_unit setSkill ["aimingShake",(0.40 + random 0.20)];
