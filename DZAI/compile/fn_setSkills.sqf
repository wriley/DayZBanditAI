...
switch (_weapongrade) do {
	case 0: {
		...
		_unit setSkill ["aimingShake",(0.25 + random 0.10)];
		_unit setSkill ["aimingSpeed",(0.50 + random 0.10)];
		_unit setSkill ["endurance",(0.40 + random 0.20)];
		_unit setSkill ["spotDistance",(0.35 + random 0.20)];
	...
	case 1: {
		...
		_unit setSkill ["aimingShake",(0.35 + random 0.10)];
		...
		_unit setSkill ["reloadSpeed",(0.60 + random 0.20)];
	...
	case 2: {
		...
		_unit setSkill ["aimingAccuracy",(0.30 + random 0.10)];
	...
	case 3: {
		...
		_unit setSkill ["aimingShake",(0.65 + random 0.10)];
		_unit setSkill ["aimingSpeed",(0.75 + random 0.20)];
		_unit setSkill ["endurance",(0.80 + random 0.20)];
		_unit setSkill ["spotDistance",(0.80 + random 0.20)];
