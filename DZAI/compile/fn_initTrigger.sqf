...
if (DZAI_debugLevel > 1) then {diag_log format["DZAI Extended Debug: Init. static trigger %1. PatrolDist: %2, GradeChances: %3, MarkerArray: %4.",_trigger,_patrolDist,_gradeChances,_markerArray];};
