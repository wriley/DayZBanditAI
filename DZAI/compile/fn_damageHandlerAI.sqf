...
_gethit=_unit getVariable ["gethit",[0,0,0,0]]; 		// Retrieve unit's health statistics

switch (_selection) do {                                                                                           		// Depending on which part of body is damaged
    case "":{                                                                                                         	// Overall structure damage
        _damage = (damage _unit) + _damage * (_dmgFactors select 0)                                             		// Total damage to unit + percentage of incoming damage
    };
