...
_unit = [_unitGroup,_respawnLoc,_patrolDist,_trigger,_markerArray,3,_equipType] call fnc_createAI;		//Spawn unit at exact marker position (Marker must be placed in a clear area that can hold at least 5 units)
