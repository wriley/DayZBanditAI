...
*/
private ["_patrolDist","_respawnLoc","_spawnRadius","_pos","_unitGroup","_unit","_trigger","_gradeChances"];
...
_unit = [_unitGroup,_pos,_trigger,_respawnLoc,1,_gradeChances] call fnc_createAI;		
