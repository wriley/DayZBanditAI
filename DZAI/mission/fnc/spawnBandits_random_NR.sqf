...
*/
private ["_unitGroup","_patrolDist","_spawnRadius","_totalAI","_triggerPos","_pos","_equipType"];
...
for "_i" from 1 to _totalAI do {
	private ["_unit"];
	_unit = [_unitGroup,_pos,_patrolDist,_trigger,_equipType] call fnc_createAI_NR;
