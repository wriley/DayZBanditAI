...
*/
private ["_patrolDist","_respawnLoc","_p","_pos","_buildingPositions","_unitGroup","_posVariance","_unit","_trigger","_grpArray","_gradeChances"];
...
_unit = [_unitGroup,_pos,_trigger,_respawnLoc,2,_gradeChances] call fnc_createAI;
