/*
	spawnTriggers_random version 0.05

	Usage: 
	Description: 
*/
private ["_numTriggers","_refMarker","_maxDist","_markerPos", "_trigOnAct"];
...
_trigOnAct = format["[%1,%2,%3,thisTrigger] call fnc_spawnBandits_random",DZAI_randMinAI,DZAI_randAddAI,_patroldist];
