//Chernarus map configuration 0.08
...
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "0 = [2,1,125,thisTrigger,['Balota1','Balota2','Balota3','Balota4','Balota5'],1] call fnc_spawnBandits;", "0 = [thisTrigger] spawn fnc_despawnBandits;"];
_trigger_6 = _this;
...
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "0 = [2,0,150,thisTrigger,[],1,2] call fnc_spawnBandits;", "0 = [thisTrigger] spawn fnc_despawnBandits;"];
_trigger_16 = _this;
...
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "0 = [1,2,125,thisTrigger,['NEAF1','NEAF2','NEAF3','NEAF4','NEAF5'],2] call fnc_spawnBandits;", "0 = [thisTrigger] spawn fnc_despawnBandits;"];
_trigger_56 = _this;
...
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "0 = [0,3,150,thisTrigger,[],2] call fnc_spawnBandits;", "0 = [thisTrigger] spawn fnc_despawnBandits;"];
_trigger_58 = _this;
...
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "0 = [3,1,150,thisTrigger,[],3,2] call fnc_spawnBandits;", "0 = [thisTrigger] spawn fnc_despawnBandits;"];
_trigger_70 = _this;
...
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "0 = [2,2,150,thisTrigger,['Elektro1','Elektro2','Elektro3','Elektro4','Elektro5'],1] call fnc_spawnBandits;", "0 = [thisTrigger] spawn fnc_despawnBandits;"];
_trigger_156 = _this;
...
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "0 = [3,2,150,thisTrigger,['Cherno1','Cherno2','Cherno3','Cherno4','Cherno5'],1] call fnc_spawnBandits;", "0 = [thisTrigger] spawn fnc_despawnBandits;"];
_trigger_160 = _this;
