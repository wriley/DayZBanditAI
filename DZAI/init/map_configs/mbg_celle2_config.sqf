...
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [3,1,180,thisTrigger,[],1,2] call fnc_spawnBandits;", "nul = [thisTrigger] spawn fnc_despawnBandits;"];
_trigger_89 = _this;
