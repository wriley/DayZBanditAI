...
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [4,1,125,thisTrigger,1] call fnc_spawnBandits_bldgs;", "nul = [thisTrigger] spawn fnc_despawnBandits;"];
_trigger_8 = _this;
...
diag_log "Oring configuration loaded";
