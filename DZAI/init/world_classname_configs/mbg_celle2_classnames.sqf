...
//Invalid entries removed from DZAI_RiflesDefault3: ["RH_mp7RFX","RH_m60e4eotech"]
...
//Remove classnames
DZAI_BanditTypesDefault = DZAI_BanditTypesDefault - ["Camo1_DZ","Sniper1_DZ","Bandit1_DZ"];
DZAI_PistolsDefault0 = DZAI_PistolsDefault0 - ["Makarov"];
DZAI_RiflesDefault1 = DZAI_RiflesDefault1 - ["AK_74","AKS_74_kobra","AKS_74_U","AK_47_M"];
DZAI_RiflesDefault2 = DZAI_RiflesDefault2 - ["AK_74","AKS_74_kobra","AKS_74_U","AK_47_M","M240_DZ","M107_DZ"];
DZAI_RiflesDefault3 = DZAI_RiflesDefault3 - ["M107_DZ"];
...
for "_i" from 0 to ((count _newItems) - 1) do {DZAI_DefaultEdibles set [(count DZAI_DefaultEdibles),(_newItems select _i)];};
