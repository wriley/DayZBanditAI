...
switch (DZAI_modName) do {
	case "2017":
	{
		...
		DZAI_Pistols0 = ["revolver_EP1","Makarov","Tokarev"];
		DZAI_Pistols1 = ["revolver_EP1","Makarov","Tokarev"];
		DZAI_Pistols2 = ["revolver_EP1","Makarov","Tokarev"];
		DZAI_Pistols3 = [];
		DZAI_Rifles0 = ["LeeEnfield","Winchester1866","Crossbow","MR43","Mosin38"];
		DZAI_Rifles1 = ["LeeEnfield","Winchester1866","Remington870_lamp","Mosin38"];
		DZAI_Rifles2 = ["LeeEnfield","Winchester1866","Remington870_lamp","Mosin38","M16_FlashLight","M4_FlashLight"];
		DZAI_Rifles3 = [];
	...
	case "civilian":
	{
		...
		DZAI_Rifles0 = DZAI_Rifles0 - ["MR43"];
