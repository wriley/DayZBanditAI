...
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [3,1,10,['Seraja1','Seraja2','Seraja3','Seraja4','Seraja5','Seraja6','Seraja7','Seraja8','Seraja9','Seraja10']] call fnc_spawnBandits_markers;", ""];
_trigger_0 = _this;
...
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [2,1,10,['SAB1','SAB2','SAB3','SAB4','SAB5']] call fnc_spawnBandits_markers;", ""];
_trigger_2 = _this;
...
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [2,2,10,['SebMine1','SebMine2','SebMine3','SebMine4','SebMine5','SebMine6','SebMine7','SebMine8','SebMine9','SebMine10','SebMine11','SebMine12','SebMine13','SebMine14','SebMine15','SebMine16','SebMine17','SebMine18','SebMine19','SebMine20']] call fnc_spawnBandits_markers;", ""];
_trigger_4 = _this;
...
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [4,1,50,['ObjectA2_1','ObjectA2_2','ObjectA2_3','ObjectA2_4','ObjectA2_5','ObjectA2_6','ObjectA2_7','ObjectA2_8','ObjectA2_9']] call fnc_spawnBandits_markers;", ""];
_trigger_6 = _this;
...
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [1,1,10,['SebChem1','SebChem2','SebChem3','SebChem4','SebChem5','SebChem6','SebChem7','SebChem8','SebChem9','SebChem10']] call fnc_spawnBandits_markers;", ""];
_trigger_16 = _this;
...
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [1,1,10,['Seb1','Seb2','Seb3','Seb4','Seb5','Seb6','Seb7','Seb8','Seb9','Seb10']] call fnc_spawnBandits_markers;", ""];
_trigger_18 = _this;
...
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [2,2,10,['OldHosp1','OldHosp2','OldHosp3','OldHosp4','OldHosp5','OldHosp6','OldHosp7','OldHosp8','OldHosp9','OldHosp10','OldHosp11','OldHosp12','OldHosp13','OldHosp14','OldHosp15','OldHosp16','OldHosp17','OldHosp18','OldHosp19','OldHosp20']] call fnc_spawnBandits_markers;", ""];
_trigger_20 = _this;
...
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [2,1,10,['Harb1','Harb2','Harb3','Harb4','Harb5','Harb6','Harb7','Harb8','Harb9','Harb10']] call fnc_spawnBandits_markers;", ""];
_trigger_22 = _this;
...
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [2,2,10,['SebMine1','SebMine2','SebMine3','SebMine4','SebMine5','SebMine6','SebMine7','SebMine8','SebMine9','SebMine10']] call fnc_spawnBandits_markers;", ""];
_trigger_30 = _this;
...
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [0,3,10,['Outskirts1','Outskirts2','Outskirts3','Outskirts4','Outskirts5']] call fnc_spawnBandits_markers;", ""];
_trigger_34 = _this;
...
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [0,1,10,['Tara1','Tara2','Tara3','Tara4','Tara5','Tara6','Tara7','Tara8','Tara9','Tara10']] call fnc_spawnBandits_markers;", ""];
_trigger_48 = _this;
...
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [1,1,10,['SebMarsh1','SebMarsh2','SebMarsh3','SebMarsh4','SebMarsh5']] call fnc_spawnBandits_markers;", ""];
_trigger_60 = _this;
...
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [2,1,50,['CrashedC1301','CrashedC1302','CrashedC1303','CrashedC1304','CrashedC1305','CrashedC1306']] call fnc_spawnBandits_markers;", ""];
_trigger_73 = _this;
...
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [2,1,5,['Vorkuta1','Vorkuta2','Vorkuta3','Vorkuta4','Vorkuta5']] call fnc_spawnBandits_markers;", ""];
_trigger_75 = _this;
...
_this = createMarker ["SebChem1", [6430.959, 9327.7119, 3.8146973e-006]];
_this setMarkerType "Empty";
_this setMarkerBrush "Solid";
_marker_32 = _this;

_this = createMarker ["SebChem2", [6430.8662, 9313.1064, 0]];
_this setMarkerType "Empty";
_this setMarkerBrush "Solid";
_marker_33 = _this;

_this = createMarker ["SebChem4", [6530.5381, 9300.8545, 1.5258789e-005]];
_this setMarkerType "Empty";
_this setMarkerBrush "Solid";
_marker_35 = _this;
...
_this = createMarker ["SebChem5", [6436.4829, 9282.0723, 2.5462837]];
_this setMarkerType "Empty";
_this setMarkerBrush "Solid";
_marker_171 = _this;
