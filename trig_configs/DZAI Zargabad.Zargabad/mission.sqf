...
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [3,2,300,thisTrigger] spawn fnc_spawnBandits;", ""];
_trigger_13 = _this;
...
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [4,2,300,thisTrigger] spawn fnc_spawnBandits;", ""];
_trigger_21 = _this;
