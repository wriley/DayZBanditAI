...
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "0 = [2,1,150,thisTrigger,2] call fnc_spawnBandits_bldgs;", "0 = [thisTrigger] spawn fnc_despawnBandits;"];
_trigger_0 = _this;
...
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "0 = [2,1,175,thisTrigger,2] call fnc_spawnBandits_bldgs;", "0 = [thisTrigger] spawn fnc_despawnBandits;"];
_trigger_2 = _this;
...
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "0 = [2,1,175,thisTrigger] call fnc_spawnBandits_bldgs;", "0 = [thisTrigger] spawn fnc_despawnBandits;"];
_trigger_5 = _this;

_this = createTrigger ["EmptyDetector", [10648.018, 9272.71, 0.036804199]];
_this setTriggerArea [500, 500, 0, false];
_this setTriggerActivation ["ANY", "PRESENT", true];
_this setTriggerTimeout [20, 40, 60, true];
...
_this setTriggerTimeout [20, 40, 60, true];
_this setTriggerText "Paraiso South";
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "0 = [0,1,150,thisTrigger] call fnc_spawnBandits_bldgs;", "0 = [thisTrigger] spawn fnc_despawnBandits;"];
_trigger_18 = _this;
...
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "0 = [0,1,125,thisTrigger] call fnc_spawnBandits_bldgs;", "0 = [thisTrigger] spawn fnc_despawnBandits;"];
_trigger_23 = _this;
...
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "0 = [1,2,175,thisTrigger,0] call fnc_spawnBandits_bldgs;", "0 = [thisTrigger] spawn fnc_despawnBandits;"];
_trigger_31 = _this;
...
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "0 = [0,2,150,thisTrigger,0] call fnc_spawnBandits_bldgs;", "0 = [thisTrigger] spawn fnc_despawnBandits;"];
_trigger_37 = _this;
...
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "0 = [0,1,150,thisTrigger,0] call fnc_spawnBandits_bldgs;", "0 = [thisTrigger] spawn fnc_despawnBandits;"];
_trigger_40 = _this;
...
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "0 = [1,1,175,thisTrigger,1] call fnc_spawnBandits_bldgs;", "0 = [thisTrigger] spawn fnc_despawnBandits;"];
_trigger_46 = _this;
...
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "0 = [0,1,130,thisTrigger,0] call fnc_spawnBandits_bldgs;", "0 = [thisTrigger] spawn fnc_despawnBandits;"];
_trigger_49 = _this;
...
_this setTriggerTimeout [20, 40, 60, true];
_this setTriggerText "OretgoN";
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "0 = [1,1,125,thisTrigger,2] call fnc_spawnBandits_bldgs;", "0 = [thisTrigger] spawn fnc_despawnBandits;"];
_trigger_61 = _this;
...
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "0 = [1,1,125,thisTrigger] call fnc_spawnBandits_bldgs;", "0 = [thisTrigger] spawn fnc_despawnBandits;"];
_trigger_67 = _this;
...
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "0 = [2,1,185,thisTrigger,1] call fnc_spawnBandits_bldgs;", "0 = [thisTrigger] spawn fnc_despawnBandits;"];
_trigger_70 = _this;
...
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "0 = [1,1,130,thisTrigger,0] call fnc_spawnBandits_bldgs;", "0 = [thisTrigger] spawn fnc_despawnBandits;"];
_trigger_76 = _this;
...
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "0 = [0,1,125,thisTrigger,0] call fnc_spawnBandits_bldgs;", "0 = [thisTrigger] spawn fnc_despawnBandits;"];
_trigger_82 = _this;
...
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "0 = [1,1,150,thisTrigger,1] call fnc_spawnBandits_bldgs;", "0 = [thisTrigger] spawn fnc_despawnBandits;"];
_trigger_88 = _this;
...
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "0 = [2,1,150,thisTrigger,1] call fnc_spawnBandits_bldgs;", "0 = [thisTrigger] spawn fnc_despawnBandits;"];
_trigger_94 = _this;
...
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "0 = [1,2,150,thisTrigger] call fnc_spawnBandits_bldgs;", "0 = [thisTrigger] spawn fnc_despawnBandits;"];
_trigger_103 = _this;
...
_this setTriggerTimeout [20, 40, 60, true];
_this setTriggerText "Default";
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "0 = [1,1,150,thisTrigger] call fnc_spawnBandits_bldgs;", "0 = [thisTrigger] spawn fnc_despawnBandits;"];
_trigger_109 = _this;
...
_this setTriggerTimeout [20, 40, 60, true];
_this setTriggerText "Default";
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "0 = [2,2,150,thisTrigger] call fnc_spawnBandits_bldgs;", "0 = [thisTrigger] spawn fnc_despawnBandits;"];
_trigger_119 = _this;
...
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "0 = [2,2,125,thisTrigger,3] call fnc_spawnBandits_bldgs;", "0 = [thisTrigger] spawn fnc_despawnBandits;"];
_trigger_127 = _this;
...
_this setTriggerTimeout [20, 40, 60, true];
_this setTriggerText "Default";
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "0 = [2,1,200,thisTrigger] call fnc_spawnBandits_bldgs;", "0 = [thisTrigger] spawn fnc_despawnBandits;"];
_trigger_129 = _this;
...
_this setTriggerTimeout [20, 40, 60, true];
_this setTriggerText "Default";
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "0 = [2,1,90,thisTrigger,2] call fnc_spawnBandits_bldgs;", "0 = [thisTrigger] spawn fnc_despawnBandits;"];
_trigger_133 = _this;
...
_this setTriggerTimeout [20, 40, 60, true];
_this setTriggerText "Default";
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "0 = [1,2,175,thisTrigger] call fnc_spawnBandits_bldgs;", "0 = [thisTrigger] spawn fnc_despawnBandits;"];
_trigger_160 = _this;
...
_this = createMarker ["Marker", [20190.494, 20362.332, -4.4703484e-006]];
