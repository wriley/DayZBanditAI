...
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [4,1,300,thisTrigger] call fnc_spawnBandits;", ""];
_trigger_0 = _this;
...
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [3,1,300,thisTrigger] call fnc_spawnBandits;", ""];
_trigger_2 = _this;
...
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [2,1,300,thisTrigger] call fnc_spawnBandits;", ""];
_trigger_8 = _this;
...
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [1,1,200,thisTrigger] call fnc_spawnBandits;", ""];
_trigger_12 = _this;
...
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [2,1,200,thisTrigger] call fnc_spawnBandits;", ""];
_trigger_18 = _this;
...
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [3,1,200,thisTrigger] call fnc_spawnBandits;", ""];
_trigger_22 = _this;
...
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [2,2,300,thisTrigger] call fnc_spawnBandits;", ""];
_trigger_24 = _this;
...
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [1,1,300,thisTrigger] call fnc_spawnBandits;", ""];
_trigger_26 = _this;
...
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [4,1,200,thisTrigger] call fnc_spawnBandits;", ""];
_trigger_46 = _this;
...
_this setTriggerTimeout [30, 60, 90, true];
_this setTriggerText "Podkoren-KranjskaGora";
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [1,0,200,thisTrigger] call fnc_spawnBandits;", ""];
_trigger_114 = _this;
