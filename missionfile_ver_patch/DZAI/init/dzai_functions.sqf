...
BIS_fnc_selectRandom2 = compile preprocessFileLineNumbers "DZAI\compile\fn_selectRandom.sqf";
...
DZAI_AI_killed_all = compile preprocessFileLineNumbers "DZAI\compile\ai_killed_all.sqf";
DZAI_AI_killed_static = compile preprocessFileLineNumbers "DZAI\compile\ai_killed_static.sqf";
DZAI_AI_killed_dynamic = compile preprocessFileLineNumbers "DZAI\compile\ai_killed_dynamic.sqf";
DZAI_unitDeath = compile preprocessFileLineNumbers "DZAI\compile\ai_death.sqf";
...
DZAI_setup_AI = compile preprocessFileLineNumbers "DZAI\compile\fn_createGroup.sqf";
DZAI_AI_handledamage = compile preprocessFileLineNumbers "DZAI\compile\fn_damageHandlerAI2.sqf";
DZAI_BIN_taskPatrol = compile preprocessFileLineNumbers "DZAI\compile\BIN_taskPatrol.sqf";
if (DZAI_debugMarkers < 1) then {
	DZAI_autoRearm_unit = compile preprocessFileLineNumbers "DZAI\compile\unit_resupply.sqf";
} else {
	DZAI_autoRearm_unit = compile preprocessFileLineNumbers "DZAI\compile\unit_resupply_debug.sqf";
};
if (DZAI_findKiller) then {
	DZAI_huntKiller = compile preprocessFileLineNumbers "DZAI\compile\fn_findKiller.sqf";
};
DZAI_dyn_huntPlayer = compile preprocessFileLineNumbers "DZAI\compile\fn_seekPlayer.sqf";
DZAI_addLoot = compile preprocessFileLineNumbers "DZAI\compile\ai_generate_loot.sqf";
DZAI_setupLoadout = compile preprocessFileLineNumbers "DZAI\compile\ai_setup_loadout.sqf";
	
//Compile spawn scripts
fnc_spawnBandits = compile preprocessFileLineNumbers "DZAI\spawn_functions\spawnBandits.sqf";
fnc_spawnBandits_custom	= compile preprocessFileLineNumbers "DZAI\spawn_functions\spawnBandits_custom.sqf";
fnc_respawnBandits = compile preprocessFileLineNumbers "DZAI\spawn_functions\respawnBandits.sqf";
fnc_respawnHandler = compile preprocessFileLineNumbers "DZAI\spawn_functions\respawnHandler2.sqf";
fnc_despawnBandits = compile preprocessFileLineNumbers "DZAI\spawn_functions\despawnBandits.sqf";

if (DZAI_dynAISpawns) then {
	fnc_spawnBandits_dynamic = compile preprocessFileLineNumbers "DZAI\spawn_functions\spawnBandits_dynamicV2.sqf";
	fnc_despawnBandits_dynamic = compile preprocessFileLineNumbers "DZAI\spawn_functions\despawnBandits_dynamicV2.sqf";
};

//Helicopter patrol scripts
if (DZAI_maxHeliPatrols > 0) then {
	if (DZAI_debugMarkers < 1) then {
		DZAI_autoRearm_heli = compile preprocessFileLineNumbers "DZAI\compile\heli_resupply.sqf";
	} else {
		DZAI_autoRearm_heli = compile preprocessFileLineNumbers "DZAI\compile\heli_resupply_debug.sqf";
	};
	DZAI_spawnHeliPatrol = compile preprocessFileLineNumbers "DZAI\spawn_functions\spawn_heliPatrol.sqf";
	DZAI_airLanding = compile preprocessFileLineNumbers "DZAI\compile\heli_airlanding.sqf";
	DZAI_heliGetOut = compile preprocessFileLineNumbers "DZAI\compile\heli_getout.sqf";
	DZAI_hHandleDamage = compile preprocessFileLineNumbers "DZAI\compile\heli_handledamage.sqf";
	DZAI_heliDestroyed = compile preprocessFileLineNumbers "DZAI\compile\heli_destroyed.sqf";
...
if (DZAI_maxLandPatrols > 0) then {
	...
	DZAI_vehDespawn = compile preprocessFileLineNumbers "DZAI\spawn_functions\veh_despawn.sqf";
	if (DZAI_debugMarkers < 1) then {
		DZAI_autoRearm_veh = compile preprocessFileLineNumbers "DZAI\compile\veh_autorearm.sqf";
	} else {
		DZAI_autoRearm_veh = compile preprocessFileLineNumbers "DZAI\compile\veh_autorearm_debug.sqf";
	};
	DZAI_spawnVehPatrol	= compile preprocessFileLineNumbers "DZAI\spawn_functions\spawn_vehpatrol.sqf";
	DZAI_vehGetOut = compile preprocessFileLineNumbers "DZAI\compile\veh_getout.sqf";
	DZAI_vHandleDamage = compile preprocessFileLineNumbers "DZAI\compile\veh_handledamage.sqf";
