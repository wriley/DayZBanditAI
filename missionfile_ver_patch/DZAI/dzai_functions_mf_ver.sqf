/*
	...
	Last Updated: 6:36 PM 12/17/2013
*/
...
if (DZAI_maxHeliPatrols > 0) then {
	...
	DZAI_heliGetOut = {
		#include "compile\heli_getout.sqf"
	};
	DZAI_hHandleDamage = {
		#include "compile\heli_handledamage.sqf"
	};
	DZAI_heliDestroyed = {
		#include "compile\heli_destroyed.sqf"
	};
...
if (DZAI_maxLandPatrols > 0) then {
	...
	DZAI_vehDespawn ={ 
		#include "spawn_functions\veh_despawn.sqf"
	};
	if (DZAI_debugMarkers < 1) then {
		DZAI_autoRearm_veh = { 
			#include "compile\veh_autorearm.sqf"
		};
	} else {
		DZAI_autoRearm_veh = { 
			#include "compile\veh_autorearm_debug.sqf"
		};
	};
	DZAI_spawnVehPatrol	= { 
		#include "spawn_functions\spawn_vehpatrol.sqf"
	};
	DZAI_vehGetOut = {
		#include "compile\veh_getout.sqf"
	};
	DZAI_vHandleDamage = {
		#include "compile\veh_handledamage.sqf"
	};
